...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0;i <100 ; i++) {
            Flight f = new Flight(70+i, "Indigo", 200, 0, "Chennai",
                    "Tamil Nadu",departureTime,arrivalTime);
            //flights[i] = f;
            registerFlight(f);
        }
        ...
        for(int i = 0;i <10 ; i++) {
            Flight f = new Flight(134+i, "Air India", 200, 0, "Chennai",
                    "Tamil Nadu",departureTime,arrivalTime);
            registerFlight(f);
        }
        for(int i = 0; i < 10 ;i++) {
            Passenger p = new Passenger("walter"+i,"9845655562"+i,
                    i+"guru@gmail.com","Anand street", "Chennai","Tamil Nadu");
            registerPassenger(p);
        }
        for(int i=0;i<10;i++) {
